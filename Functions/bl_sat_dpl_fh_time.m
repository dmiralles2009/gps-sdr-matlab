...
%> exponential multiplication. Structure for detection is sat->doppler->buckets.  
...
%>
%> @date      May 15, 2014
%> @pre       Former File Name: BL_SAT_DPL_FH_TIME.m
%> @bug       Code Phase delay may be different by 1 unit.
%> @note      This file represents the function version of the file name BL_SAT_DPL_TIME.m
...
%>
% =========================================================================
function whole_set = bl_sat_dpl_fh_time(dataset,fs,fi,satellites,thresholdbaseline)
